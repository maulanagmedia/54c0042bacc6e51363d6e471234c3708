...
public class TestPrinter extends AppCompatActivity implements ReceiveListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        printerManager = new SavedPrinterManager(TestPrinter.this);
    ...
    private boolean connectPrinter() {
        ...
        try {
            mPrinter.connect(printerManager.getData(SavedPrinterManager.TAG_IP2), Printer.PARAM_DEFAULT);
        }
        catch (Exception e) {
