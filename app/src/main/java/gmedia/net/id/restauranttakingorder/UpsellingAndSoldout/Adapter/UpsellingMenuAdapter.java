package gmedia.net.id.restauranttakingorder.UpsellingAndSoldout.Adapter;
...
public class UpsellingMenuAdapter extends ArrayAdapter{

    private Activity context;
    private List<CustomItem> items;
    private ItemValidation iv = new ItemValidation();

    public UpsellingMenuAdapter(Activity context, List<CustomItem> items) {
        super(context, R.layout.adapter_menu_upselling, items);
        this.context = context;
        this.items = items;
    }

    private static class ViewHolder {
        private TextView tvItem1, tvItem2, tvItem3, tvThumbnail;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.adapter_menu_upselling, null);
        ...
        holder.tvItem3.setText( cli.getItem5());
